...
<head>
	...
	<link href="{{ asset('landing2/css/starjedi.css') }}" rel="stylesheet"> 
	<link href="https://fonts.googleapis.com/css?family=Open+Sans:600,700%7CRoboto:300,400,500,700" rel="stylesheet"> 

	<!-- Icons -->
	<link rel="stylesheet" href="{{ asset('landing2/css/linearicons.css') }}">
	<link rel="stylesheet" href="{{ asset('landing2/css/font-awesome.min.css') }}">
	...
	<link rel="stylesheet" href="{{ asset('landing2/css/animate.min.css') }}">
	<link rel="stylesheet" href="{{ asset('landing2/css/magnific-popup.css') }}">
	<link rel="stylesheet" href="{{ asset('landing2/css/main-custom.css') }}">
...
<body class="body" data-spy="scroll" data-target=".header" data-offset="60">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<a data-scroll href="#home" class="header__logo">
						<img class="header__logo-white" src="{{ asset('landing2/img/logo.png') }}" alt="Logo">
						<img class="header__logo-dark" src="{{ asset('landing2/img/logo--dark.png') }}" alt="Logo">
					</a>
					<!-- end logo -->
	...
	<!-- home -->
	<section id="home" class="home section--bg" data-bg="{{ asset('landing2/img/home/slide-custom.png') }}">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<!-- home content -->
					<div class="home__content-wrap">
						<div class="home__content">
							...
							<h2 class="home__text">A United Africa</h2>
							<a data-scroll href="#about" ><span class="learn_more">Learn More</span></a>							
						</div>
					</div>
					<!-- end home content -->
				</div>
	...
	<section id="about" class="about">
		<div class="container">
			<div class="row">
				<!-- section title -->
				<div class="col-xs-12">
					<h2 class="section__title section__title--margin">About Africoin</h2>
				</div>
				<!-- end section title -->
					...
					<div class="col-xs-12 col-lg-3">
						<div class="download_pdf">
							<div class="download_pdf_icon">
								<img src="{{asset('landing2/img/new/down_pdf.png')}}"/>
							</div>
	...
	<section id="features" class="section section--grey">
		<div class="container">
			<div class="row">
				<!-- section title -->
				<div class="col-xs-12">
					<h2 class="section__title section__title--underline">Features</h2>
	...
	<!-- safety -->
	<section class="section section--bg retailer_brands" data-bg="{{ asset('landing2/img/section-bg/section-bg5.png') }}">
		<div class="container">
			<div class="row">
				<!-- section title -->
				<div class="col-xs-12">
					<h2 class="section__title">Retailers And Brands</h2>
				</div>
				<!-- end section title -->
	...
	<!-- counter -->
	<!-- <div class="section counter" data-parallax="scroll" data-image-src="{{ asset('landing2/img/section-bg/section-bg3.jpg') }}">
		<div class="container">
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<article class="article">
						<figure class="article__img">
							<a href="#">
								<img src="{{ asset('landing2/img/blog/1.jpg') }}" alt="">
							</a>
						</figure>
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<article class="article">
						<figure class="article__img">
							<a href="#">
								<img src="{{ asset('landing2/img/blog/2.jpg') }}" alt="">
							</a>
						</figure>
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<article class="article">
						<figure class="article__img">
							<a href="#">
								<img src="{{ asset('landing2/img/blog/3.jpg') }}" alt="">
							</a>
						</figure>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1">
					...
					<div class="feature1__img">
						<img src="{{ asset('landing2/img/section-bg/section-bg4.png') }}" style="width:100%" />
					</div>
					<!-- end info content -->
				</div>
	...
	<footer class="footer">
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12">
					<!-- copyright -->
					<small class="footer__copyright">© 2018 <a href="#">AFRICOIN &trade;</a> Create by <a href="#">Anja Seric</a></small>
					<!-- end copyright -->
				</div>
			</div>
		</div>
			...
			<div class="footer__logo">
				<div class="row" style="display:flex; align-items:center">
					<div class="col-xs-12 col-md-9">					
						<img src="{{ asset('landing2/img/logo.png') }}"/>
						&nbsp; © 2018 AFRICOIN &trade;
					</div>
	...
	<div class="preloader">
		<div class="preloader__logo">
			<img src="{{ asset('landing2/img/logo--dark.png') }}" alt="">
		</div>
	...
	<!-- JS -->
	<script src="{{ asset('landing2/js/jquery-2.2.4.min.js') }}"></script>
	<script src="{{ asset('landing2/js/bootstrap.min.js') }}"></script>
	<script src="{{ asset('landing2/js/owl.carousel.min.js') }}"></script>
	<script src="{{ asset('landing2/js/jquery.marquee.min.js') }}"></script>
	<script src="{{ asset('landing2/js/smooth-scroll.min.js') }}"></script>
	<script src="{{ asset('landing2/js/jquery.magnific-popup.min.js') }}"></script>
	<script src="{{ asset('landing2/js/parallax.min.js') }}"></script>
	<script src="{{ asset('landing2/js/scrolla.jquery.min.js') }}"></script>
	<script src="{{ asset('landing2/js/jquery.waypoints.min.js') }}"></script>
	<script src="{{ asset('landing2/js/jquery.counterup.min.js') }}"></script>
	<script src="{{ asset('landing2/js/imagesloaded.pkgd.min.js') }}"></script>
